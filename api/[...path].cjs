...
app.get('/api/schedules/:userId', async (req, res) => {
  ...
  // Note: Complex auto-update logic is simplified here. 
  // In a real production environment, this should be done by a Supabase cron job or before fetch.
  // We'll update the records that are passed.
